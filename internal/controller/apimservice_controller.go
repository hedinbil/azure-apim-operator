...
//+kubebuilder:rbac:groups=apim.hedinit.io,resources=apimservices,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=apim.hedinit.io,resources=apimservices/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=apim.hedinit.io,resources=apimservices/finalizers,verbs=update
