...
// DeployAPIReconciler reconciles a DeployAPI object
type DeployAPIReconciler struct {
	client.Client
...
// the DeployAPI object against the actual cluster state, and then
...
func (r *DeployAPIReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&apimv1.DeployAPI{}).
		Named("deployapi").
		Complete(r)
}
