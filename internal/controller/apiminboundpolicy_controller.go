...
// +kubebuilder:rbac:groups=apim.hedinit.io,resources=apiminboundpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apim.hedinit.io,resources=apiminboundpolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=apim.hedinit.io,resources=apiminboundpolicies/finalizers,verbs=update
