...
// IngressWatcherStatus defines the observed state of IngressWatcher.
type IngressWatcherStatus struct {
...
type IngressWatcher struct {
	...
	Spec   IngressWatcherSpec   `json:"spec,omitempty"`
...
type IngressWatcherList struct {
	...
	Items           []IngressWatcher `json:"items"`
}

func init() {
	SchemeBuilder.Register(&IngressWatcher{}, &IngressWatcherList{})
}
